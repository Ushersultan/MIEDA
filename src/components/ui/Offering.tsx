...
const TXT = {
  fr: {
    badge: "Don à la Mission — MIEDA Diaspora",
    ...
    citation: "« Chacun donne ce qu'il a décidé en son cœur, sans tristesse ni contrainte, car Dieu aime celui qui donne avec joie. »",
    ...
    enLigne: "Faites un don en ligne",
    type: "Type de don", periodique: "Récurrent", ponctuel: "Ponctuel",
    ...
    waveNote: "Faites un don par Wave Money directement via l'application.",
    iban: "Virement IBAN", france: "France / International 🇫🇷",
    ibanNote: "Précisez « Don MIEDA » en libellé de votre virement.",
...
const PayPalForm = ({ L }: { L: typeof TXT.fr }) => {
  ...
  const handleGive = () => {
    ...
    if (!val || val <= 0) return;
    const base = type === "periodique" ? "Don mensuel MIEDA" : "Don ponctuel MIEDA";
